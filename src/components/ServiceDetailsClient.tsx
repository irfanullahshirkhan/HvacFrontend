        ...
        <div className="relative z-20 w-full max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between h-full">
          <div className="pt-16 md:pt-0">
            ...
            <nav className="text-white text-sm flex items-center gap-2">
              ...
              <span className="mx-1">&#8250;</span>
              <span className="opacity-80">Service Details</span>
            </nav>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1">
              <h2 className="text-3xl md:text-4xl font-semibold text-blue-900 mb-4">
                Worry free with{" "}
                <span className="text-blue-400 font-bold">certified</span> HVAC
                service
              </h2>
              <p className="text-gray-500 mb-4">
                ...
                laborum nulla est sit ut ullamco duis fugiat qui elit laborum ut
                anim adipisicing sed laboris nostrud elit magna occaecat nostrud
                dolor dolore ut tempor sed in aliqua nostrud irure consequat ut
                exercitation
              </p>
              <p className="text-gray-500">
                Deserunt ex anim esse id nulla eiusmod cillum culpa culpa magna
                enim enim sit consequat eu eu ullamco proident voluptate
                voluptate eu dolore in in est mollit dolore mollit deserunt
                reprehenderit est incididunt nisi aliqua irure ex id deserunt ad
                in et dolore dolore excepteur veniam tempor commodo dolore in
